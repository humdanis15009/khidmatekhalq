      ...
      <div className="lg:mt-[60px] lg:mb-16 mb-10 lg:mr-16 lg:ml-20 overflow-hidden lg:h-[560px] relative">
        <Slider ref={sliderRef} {...settings} className="relative gap-x-6">
          ...
          <div className="flex items-center p-4">
            <div className="lg:h-[500px] h-[370px] w-[250px] mx-auto lg:w-[350px] transform transition-transform hover:scale-105 hover:bg-green-50 duration-500 shadow-2xl rounded-2xl border-pink-700 lg:p-4 p-2 flex flex-col items-center">
              <img
